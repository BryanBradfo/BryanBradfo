...
| A computer vision project from **ENS Ulm** focused on classifying sketch images. | A project with **Météo France** to classify geospatial images from the EuroSAT dataset. | Used **scikit-maad** and **VGGish** to extract acoustic indices and apply ML models to find patterns and predict naturalness. |
