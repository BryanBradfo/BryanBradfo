...
| :--- | :--- |
| **ML Engineer** @ <br> <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/Logo_Iliad.png/150px-Logo_Iliad.png" alt="Iliad Group" width=50> <br> (Apr. 2025 - Present) | As part of the **Iliad Group (Free / Scaleway)** team in Paris, I develop Generative AI (GenAI) solutions, build ETL data pipelines, and create insightful dashboards. |
