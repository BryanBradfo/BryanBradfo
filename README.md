...
| :--- | :--- |
| **AIML Research Engineer** @ <br> <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/83/Logo_Iliad.png/150px-Logo_Iliad.png" alt="Iliad" width=40> <br> (Feb. 2025 - Jan. 2026) | At **Iliad (Free)** in Paris, I generated coverage maps using an image segmentation model in the GeoAI domain, automated anomaly detection (Prophet \& SARIMAX), built ETL data pipelines, and created insightful dashboards for directors. |
